...
class MainWindow(FramelessWidget, Ui_MainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # 添加标题标签
        self.title_label = QtWidgets.QLabel("🚨 小纯Res- Translator  ️🎉", self)
        self.title_label.setObjectName("TitleLabel")  # 设置对象名以便样式表使用
        self.title_label.setGeometry(QtCore.QRect(20, 11, 200, 30))  # 调整位置和大小
